...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span style='margin-left: 22%'><b > OU DEPOSER LE FICHIER ICI</b></span>",
            abortStr: "Annuler",
            cancelStr: "Annuler",
            deletelStr: "Supprimer",
            doneStr: "Terminer",
            multiDragErrorStr: "Il ne faut pas deposer plusieurs fichiers.",
            extErrorStr: "n'est pas autorisée. les extensions autorisées sont: ",
            sizeErrorStr: "n'est pas autorisée. La taille max autorisée est: ",
            uploadErrorStr: "Ce n'est pas autorisé"
        }, options);
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
                ...
                pd.filename.html(fileNameStr+'<label for="textfield"></label><input type="hidden" name="nomfich" id="textfield" value="'+files[i].name+'">');
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            var fileInputStr = "<input class='btn medium primary-bg col-md-3' type='file' id='" + fileUploadId + "' name='" + s.fileName + "'/>";
            if (s.multiple) {
                if (s.fileName.indexOf("[]") != s.fileName.length - 2) // if it does not endwith
                {
                    s.fileName += "[]";
                }
                fileInputStr = "<input class='btn medium primary-bg col-md-3' type='file' id='" + fileUploadId + "' name='" + s.fileName + "' multiple/>";
            }
