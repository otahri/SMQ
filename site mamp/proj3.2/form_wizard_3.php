...
if(isset($_POST['analy']))
{
        
  $req = "UPDATE audit SET analyse='".$_POST['analy']."' WHERE id=".$id_audit;
...
<div class="example-box">
    <div class="example-code">
        ...
        <div class="row">
          <img src="assets/images/e3.png" width="100%" height="100%" >
		  <br>
          <br>
          <div id="step-1">

            <form action="form_wizard_4.php?id_a=<?php echo "".$id_audit ?>&id_e=<?php echo "".$id_even?>" id="formremove" class="col-md-8 center-margin" method="post">
