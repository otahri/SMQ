...
if(isset($_POST['ref'])&&isset($_POST['version'])&&isset($_POST['date'])&&isset($_POST['nomfich']))
{
  ...
  $req = "INSERT INTO documents_evenement values('','".$proc."','4','".$_POST['date']."','".$_POST['ref']."','".$_POST['version']."','../gestiondoc/arz/".$_POST['nomfich']."','".$_POST['nomfich']."','".$id_even."')";
						  ...
						  <div class="content-box border-top border-black mrg25B" >
										...
										<p> <?php 
												...
												while($ligne = mysql_fetch_array($result)) { ?>
													...
													<p><strong>Numéro de la non conformité : </strong><?php echo $ligne['code_even']; ?> <br></p>
													...
													<p><strong>Date de décision &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </strong><?php echo $ligne['datedecis']; ?> <br></p>
